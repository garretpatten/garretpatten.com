  ...
  <div class="max-w-3xl mx-auto">
    <div class="mb-8 soft-enter">
      <img
        ...
        alt="Garret Patten"
        class="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto mb-6 object-cover border-4 border-cobalt-300 dark:border-cobalt-700 shadow-[0_0_0_6px_rgba(121,150,255,0.12)] dark:shadow-[0_0_0_6px_rgba(121,150,255,0.2)]"
      />
    </div>

    <div
      class="prose prose-lg dark:prose-invert max-w-none bg-white/75 dark:bg-[#1f2335]/70 border border-iris-200 dark:border-iris-800 rounded-xl p-6 md:p-8 soft-enter soft-enter-delay-1"
    >

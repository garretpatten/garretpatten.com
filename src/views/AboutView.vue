  ...
  <div class="max-w-3xl mx-auto">
    <div class="mb-8 soft-enter">
      <img
        ...
        alt="Garret Patten"
        class="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto mb-6 object-cover border-4 border-cobalt-300 dark:border-cobalt-700 shadow-[0_0_0_6px_rgba(127,187,179,0.16)] dark:shadow-[0_0_0_6px_rgba(127,187,179,0.28)]"
      />
    </div>

    <div
      class="prose prose-lg dark:prose-invert max-w-none bg-white/75 dark:bg-evf-panel/85 border border-iris-200 dark:border-iris-800 rounded-xl p-6 md:p-8 soft-enter soft-enter-delay-1"
    >
      <p class="text-gray-700 dark:text-evf-fg leading-relaxed mb-6">

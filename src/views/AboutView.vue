  ...
  <div class="max-w-3xl mx-auto">
    <div class="mb-8 soft-enter">
      <img
        ...
        alt="Garret Patten"
        class="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto mb-6 object-cover border-4 border-cobalt-300 dark:border-cobalt-700 shadow-[0_0_0_6px_rgba(69,133,136,0.18)] dark:shadow-[0_0_0_6px_rgba(131,165,152,0.28)]"
      />
    </div>

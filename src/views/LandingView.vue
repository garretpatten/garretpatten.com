<template>
  <div class="max-w-4xl mx-auto">
    ...
    <section class="text-center mb-16 soft-enter">
      ...
      <p class="font-sans text-xl md:text-2xl text-gray-300">Husband and Father. Senior Security Engineer.</p>
    </section>

    <!-- Value Proposition -->
    <section class="mb-16 soft-enter soft-enter-delay-1">
      <p class="font-sans text-lg md:text-xl text-gray-200 leading-relaxed text-center max-w-2xl mx-auto">

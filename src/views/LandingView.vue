  ...
  <div class="max-w-4xl mx-auto">
    ...
    <section class="text-center mb-16 soft-enter soft-enter-delay-2">
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <router-link
          to="/resume"
          class="px-6 py-3 bg-sun-400 dark:bg-sun-400 text-gray-950 hover:bg-sun-500 dark:hover:bg-sun-500 rounded-lg font-medium transition-colors duration-[230ms]"
        >
          View Resume
        </router-link>
        <router-link

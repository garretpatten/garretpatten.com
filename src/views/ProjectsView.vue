...
const projects = ref([
  ...
  },
  {
    ...
    description:
      "Bash automation for Ubuntu: APT package installs, GNOME defaults, shell/terminal configuration, and optional dotfiles—modular install and config workflows with GitHub Actions CI.",

<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="md:hidden mb-6 soft-enter">
      <select
        v-model="activeTab"
        class="w-full px-4 py-3 text-sm font-medium bg-gray-50 dark:bg-gray-900 border border-cobalt-200 dark:border-cobalt-800 rounded-lg text-cobalt-900 dark:text-cobalt-100 focus:outline-none focus:ring-2 focus:ring-cobalt-500 dark:focus:ring-cobalt-300 interactive-lift"
      >
